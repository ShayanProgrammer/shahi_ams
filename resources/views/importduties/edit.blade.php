        ...
        <div class="row">
            <div class="col-12 mb-5">
                <section class="scroll-section" id="address">
                    ...
                    @endif
                    <form class="tooltip-end-top" id="addressForm" novalidate="novalidate" method="post" action="{{ route('update_importduty') }}">
                        @csrf
                        <input type="hidden" name="id" class="form-control" value="{{ $importduty->id }}">
                        <div class="card mb-5">
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <div class="w-100" data-select2-id="1">
                                                ...
                                                <select class="select-single-no-search" name="bank_id">
                                                    <option value="">Select Bank</option>
                                                    @foreach($banks as $bank)
                                                        <option value="{{ $bank->id }}" {{ $bank->id == $importduty->bank_id ? 'selected' : '' }}>{{ $bank->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" autocomplete="off" name="check" class="form-control" value="{{ $importduty->check }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label class="form-label">Payorder <span class="required">*</span></label>
                                            <input type="text" autocomplete="off" name="payorder" class="form-control" value="{{ $importduty->payorder }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" autocomplete="off" name="performa" class="form-control" value="{{ $importduty->performa }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label class="form-label">Amount <span class="required">*</span></label>
                                            <input type="number" autocomplete="off" min="1" name="amount" class="form-control" value="{{ $importduty->amount }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label class="form-label">Number of container <span class="required">*</span></label>
                                            <input type="text" autocomplete="off" name="no_of_container" class="form-control" value="{{ $importduty->no_of_container }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input placeholder="Select Date" id="datePickerInputGroup" type="text" autocomplete="off" name="date" class="form-control date-picker-close date" value="{{ $importduty->date }}" autocomplete="off">
