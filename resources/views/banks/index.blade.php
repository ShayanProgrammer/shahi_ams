            ...
            <div class="row">
                ...
                <div class="col-3 d-flex align-items-end justify-content-end">
                    ...
                    <div class="btn-group ms-1 check-all-container">
                        ...
                        <a href="{{ route('create_bank') }}" class="btn btn-outline-primary btn-icon btn-icon-start ms-0 ms-sm-1 w-100 w-md-auto">
                            <span>Add Bank</span>
                            ...
                            columns: [
                                {data: 'name', title: 'Name'},
                                {
                                    ...
                                    render: function (data, type, full, meta) {
                                        var edit_btn = '<a href="{{ url('banks/edit') }}/'+full['id']+'" class="btn btn-sm btn-icon btn-icon-start btn-outline-primary ms-1">Edit</a>';
                                        ...
                                        var importduties_btn = '<a href="{{ url('banks') }}/importduties/'+full['id']+'" class="btn btn-sm btn-icon btn-icon-start btn-outline-primary ms-1">Import Duties</a>';

                                        @if($user->role_id == 1)
                                            var account_btn = '<a href="{{ url('banks/bank_account') }}/'+full['id']+'" class="btn btn-sm btn-icon btn-icon-start btn-outline-primary ms-1">Accounts</a>';
                                        @else
                                            var account_btn = "";
                                        @endif

                                        return edit_btn + " " + delete_btn + " " + importduties_btn + " " + account_btn;
