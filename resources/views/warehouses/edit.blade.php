        ...
        <div class="row">
            <div class="col-12 mb-5">
                <section class="scroll-section" id="address">
                    ...
                    @endif
                    <form class="tooltip-end-top" id="addressForm" novalidate="novalidate" method="post" action="{{ route('update_warehouse') }}">
                        @csrf
                        ...
                        <div class="card mb-5">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" autocomplete="off" class="form-control name" value="{{ $warehouse->name }}" placeholder="Enter Warehouse Name">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer border-0 pt-0 d-flex justify-content-end align-items-center">
                                <div>
                                    ...
                                    <a class="btn btn-lg btn-icon-start btn-outline-primary ms-1" href="{{ url('warehouses') }}">
                                        <span>Back</span>
