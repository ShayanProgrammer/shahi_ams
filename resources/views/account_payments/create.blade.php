...
{{--                        <a href="{{ url()->previous() }}" class="muted-link pb-1 d-inline-block breadcrumb-back">--}}
        ...
        <div class="row">
            <div class="col-12 mb-5">
                <section class="scroll-section" id="address">
                    ...
                    @endif
                    <form class="tooltip-end-top" id="addressForm" novalidate="novalidate" method="post" action="{{ route('accountpayments.store') }}">
                        @csrf
                        <div class="card mb-5">
                            <div class="card-body">
...
{{--                                            <select placeholder="Select Company" class="select-single-no-search" style="width:100%" name="company_id">--}}
...
{{--                                        </div>--}}
{{--                                    </div>--}}
                                    <input type="hidden" value="{{ request()->segment(3) }}" name="company_id">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label class="form-label">Amount <span class="required">*</span></label>
                                            <input type="text" name="total" class="form-control" autocomplete="off" value="{{ old('total') }}" placeholder="Enter Amount">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                            ...
                            <div class="card-footer border-0 pt-0 d-flex justify-content-end align-items-center">
                                <div>
                                    ...
                                    <a href="{{ url('company_accounts/') }}/{{ Session::get('company_id') }}" class="btn btn-lg btn-icon-start btn-outline-primary ms-1">
                                        <span>Cancel</span>
