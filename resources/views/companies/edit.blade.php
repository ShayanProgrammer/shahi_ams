        ...
        <div class="row">
            <div class="col-12 mb-5">
                <section class="scroll-section" id="address">
                    ...
                    @endif
                    <form class="tooltip-end-top" id="addressForm" novalidate="novalidate" method="post" action="{{ route('update_company') }}">
                        @csrf
                                ...
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" autocomplete="off" class="form-control" value="{{ $company->name }}" placeholder="Enter Company Name"
                                        </div>
                                    </div>
                                </div>
                            </div>
