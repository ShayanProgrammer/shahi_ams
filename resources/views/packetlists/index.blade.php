            ...
            <div class="row">
                ...
                <div class="col-3 d-flex align-items-end justify-content-end">
                    ...
                    <div class="btn-group ms-1 check-all-container">
                        ...
                        <a href="{{ route('create_packetlist') }}" class="btn btn-outline-primary btn-icon btn-icon-start ms-0 ms-sm-1 w-100 w-md-auto">
                            <span>Add Packet List</span>
                            ...
                            columns: [
                                ...
                                {data: 'description', title: 'Description'},
                                {
                                    ...
                                    render: function (data, type, full, meta) {
                                        ...
                                        var edit_btn = '<a href="{{ url('packetlist/edit') }}/'+full['id']+'" class="btn btn-sm btn-icon btn-icon-start btn-outline-primary ms-1">Edit</a>';
