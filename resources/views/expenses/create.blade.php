        ...
        <div class="row">
            <div class="col-12 mb-5">
                <section class="scroll-section" id="address">
                    ...
                    @endif
                    <form class="tooltip-end-top" id="addressForm" novalidate="novalidate" method="post" action="{{ route('store_expense') }}">
                        @csrf
                        <div class="card mb-5">
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="amount" autocomplete="off" id="amount" class="form-control" value="{{ old('amount') }}" placeholder="Enter Expense Amount"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="description" autocomplete="off" id="description" class="form-control" placeholder="Enter Expense Description"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
