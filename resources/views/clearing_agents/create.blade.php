        ...
        <div class="row">
            <div class="col-12 mb-5">
                <section class="scroll-section" id="address">
                    ...
                    @endif
                    <form class="tooltip-end-top" id="addressForm" novalidate="novalidate" method="post" action="{{ route('store_clearing_agent') }}">
                        @csrf
                        <div class="card mb-5">
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="name" autocomplete="off" class="form-control name" value="{{ old('name') }}" placeholder="Enter Clearing Agent Name">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <label class="form-label">Phone <span class="required">*</span></label>
                                            <input type="text" name="phone" autocomplete="off" class="form-control phone" value="{{ old('phone') }}" placeholder="Enter Phone Number">
                                        </div>
                                    </div>
                                </div>
                            </div>
