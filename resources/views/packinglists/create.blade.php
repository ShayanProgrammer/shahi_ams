        ...
        <div class="row">
            <div class="col-12 mb-5">
                <section class="scroll-section" id="address">
                    ...
                    @endif
                    <form class="tooltip-end-top" id="addressForm" novalidate="novalidate" method="post" action="{{ route('store_packinglist') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card mb-5">
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            <div class="w-100" data-select2-id="1">
                                                ...
                                                <select class="select-single-no-search company_id" data-placeholder="Select Company" name="company_id">
...
{{--                                                    @endforeach--}}
                                    ...
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="port_name" autocomplete="off" class="form-control port_name" value="{{ old('port_name') }}" placeholder="Enter Port Name">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            <label class="form-label">Date <span class="required">*</span></label>
                                            <input type="text" name="date" autocomplete="off" class="form-control date-picker-close date" value="{{ old('date') }}" placeholder="Enter Date">
                                        </div>
                                    </div>
                                </div>
                                <br>
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <input type="file" class="form-control document_class" id="fileInput" name="file[]">
                                                        <label class="input-group-text" for="inputGroupFile02">Upload <span class="required">*</span></label>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <script>
                        $(document).ready(function(){
                            ...
                            $('.submit_btn').click(function(){
                                ...
                                var date = $('.date').val();
                                var container_number = $('.container_number_class').val();
                                var document = $('.document_class').val();

                                if(company_id === '' || Performa === null || Performa === '' || port_name === '' || date === '' || container_number.length === 0 || document === ""){
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#fileInput').change(function () {
                var allowedExtensions = ["xlsx", "pdf", "docx", "xls", "doc"];
                var fileName = $(this).val();
                var fileExtension = fileName.split('.').pop().toLowerCase();

                if ($.inArray(fileExtension, allowedExtensions) === -1) {
                    Swal.fire('Invalid file format', 'Please select a valid Excel, PDF, or Word file.', 'error');
