    ...
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-3 d-flex align-items-end justify-content-end">
                    ...
                    <div class="btn-group ms-1 check-all-container">
                        ...
                        <a href="{{ route('create_packinglist') }}" class="btn btn-outline-primary btn-icon btn-icon-start ms-0 ms-sm-1 w-100 w-md-auto">
        ...
        <script>
                            ...
                            columns: [
                                ...
                                // {data: 'file', title: 'File'},
                                {
                                    ...
                                    render: function (data, type, full, meta) {
                                        var edit_btn = '<a href="{{ url('packinglists/edit') }}/'+full['id']+'" class="btn btn-sm btn-icon btn-icon-start btn-outline-primary ms-1">Edit</a>';
            ...
            $(document).on('click','.view_detail_btn',function(){
                var packing_list_id = $(this).data('id');

                $.ajax({

                    url: "{{ url('packing_list_detail/view') }}",
                    method: 'POST',
                    data: {
                    ...
                    success: function(result){
                        ...
                        var html = '';
                        $.each(parsed.packing_list_detail, function(k, v) {
                            html += '<tr>';
