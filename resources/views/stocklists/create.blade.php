        ...
        <div class="row">
            <div class="col-12 mb-5">
                <section class="scroll-section" id="address">
                    ...
                    @endif
                    <form class="tooltip-end-top" id="addressForm" novalidate="novalidate" method="post" action="{{ route('store_stocklist') }}">
                        @csrf
                        <div class="card mb-5">
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <div class="w-100" data-select2-id="1">
                                                ...
                                                <select class="select-single-no-search" data-placeholder="Select Company" name="company_id">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <div class="w-100" data-select2-id="1">
                                                ...
                                                <select class="select-single-no-search warehouse_id" data-placeholder="Select Warehouse" name="warehouse_id">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="container_number" autocomplete="off" class="form-control" value="{{ old('container_number') }}" placeholder="Enter Container Number">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="no_of_packets" autocomplete="off" class="form-control" value="{{ old('no_of_packets') }}" placeholder="Enter Number of Packets">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
