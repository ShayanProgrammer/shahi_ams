                        ...
                        <div class="col-12 col-sm-6 col-lg-6">
                            <div class="card sh-13 sh-lg-15 sh-xl-14">
                                <div class="h-100 row g-0 card-body align-items-center py-3">
                                    ...
                                    <div class="col">
                                        <div class="p mb-0 d-flex align-items-center lh-1-25">Order Id</div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-6">
                            <div class="card sh-13 sh-lg-15 sh-xl-14">
                                <div class="h-100 row g-0 card-body align-items-center py-3">
                                    ...
                                    <div class="col">
                                        <div class="p mb-0 d-flex align-items-center lh-1-25">Order Status</div>
                        ...
                        <div class="col-12 col-sm-6 col-lg-6">
                            <div class="card sh-13 sh-lg-15 sh-xl-14">
                                <div class="h-100 row g-0 card-body align-items-center py-3">
                                    ...
                                    <div class="col">
                                        <div class="p mb-0 d-flex align-items-center lh-1-25">Delivery Date</div>
                            ...
                            <div class="card sh-13 sh-lg-15 sh-xl-14">
                                <div class="h-100 row g-0 card-body align-items-center py-3">
                                    <div class="col-auto pe-3">
                                        <div
                                            class="border border-primary sw-6 sh-6 rounded-xl d-flex justify-content-center align-items-center">
                                            <i data-cs-icon="shipping" class="text-primary"></i>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="p mb-0 d-flex align-items-center lh-1-25">Tracking Code</div>
                                ...
                                <div class="h-100">
                                    <div class="d-flex flex-column justify-content-start">
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="text-muted mt-1">Biscuit donut powder sugar plum pastry. Chupa
                                                chups topping pastry halvah.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="h-100">
                                    <div class="d-flex flex-column justify-content-start">
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="text-muted mt-1">Apple pie cotton candy tiramisu biscuit cake
                                                muffin tootsie roll bear claw cake.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex flex-column justify-content-start">
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="text-muted mt-1">
                                                Marzipan muffin cheesecake. Caramels wafer jelly beans. Icing pudding
                                                dessert caramels cake topping marzipan.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-body mb-n5">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="row g-0 mb-2">
                                ...
                                <div class="col text-alternate">4 Glamis Avenue, Strathmore Park, Wellington 6022, New
                                    Zealand
                                </div>
                            </div>
                            <div class="row g-0 mb-2">
                        ...
                        <div class="mb-5">
                            <div>
                                ...
                                <div class="row g-0 mb-2">
                                    <div class="col-auto">
                                        <div class="sw-3 me-1">
                                            <i data-cs-icon="credit-card" class="text-primary" data-cs-size="17"></i>
                                        </div>
                                    </div>
