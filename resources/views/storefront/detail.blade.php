...
@section('js_page')
    ...
    <script src="{{ asset('/js/pages/storefront.detail.js') }}"></script>
@endsection
            ...
            <div class="row">
                ...
                <div class="col-auto mb-3 mb-md-0 me-auto">
                    <div class="w-auto sw-md-50">
                        ...
                        <h1 class="mb-0 pb-0 display-4" id="title">Product Details</h1>
                    </div>
                </div>
                <!-- Title End -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-xl-7">
                                <div class="glide glide-gallery" id="glideStorefrontDetail">
                                    <span
                                        class="badge rounded-pill bg-primary me-1 position-absolute e-n2 t-4 z-index-1 py-2 px-3">20% OFF</span>
                                    <!-- Large Images Start -->
                                    ...
                                    <div class="glide glide-thumb">
                                        <div class="glide__track" data-glide-el="track">
                                            <ul class="glide__slides">
                                                ...
                                                <li class="glide__slide p-0">
                                                    <img alt="thumb" src="{{ asset('/img/product/thumb/pullman-loaf-thumb.jpg') }}"
                                                         class="responsive rounded-md img-fluid"/>
                                                </li>
                                                <li class="glide__slide p-0">
                                                    <img alt="thumb" src="{{ asset('/img/product/thumb/bauernbrot-thumb.jpg') }}"
                                                         class="responsive rounded-md img-fluid"/>
                                                </li>
                                                <li class="glide__slide p-0">
                                                    <img alt="thumb" src="{{ asset('/img/product/thumb/guernsey-gache-thumb.jpg') }}"
                                                         class="responsive rounded-md img-fluid"/>
                                                </li>
                                                <li class="glide__slide p-0">
                                                    <img alt="thumb"
                            ...
                            <div class="col-12 col-xl-5 sh-xl-60 d-flex flex-column justify-content-between">
                                <div>
                                    ...
                                    <h3 class="mb-4">Carrot Cake Gingerbread</h3>
                                    ...
                                    <div>
                                        ...
                                        <div class="text-muted d-inline-block text-small align-text-top">(25 Reviews)
                                        </div>
                                    </div>
                                    <p class="mt-2 mb-4 sh-11 clamp-line" data-line="4">
                                        Carrot cake jelly-o lemon drops toffee tootsie roll. Brownie topping toffee
                                        apple pie apple pie. Wafer pudding chocolate bar pastry
                                        bear claw tart carrot cake lemon drops icing. Gingerbread toffee topping.
                                        Tootsie roll cotton candy muffin cheesecake liquorice sweet.
                                        Sugar plum tart tart marshmallow chocolate wafer apple pie candy canes.
                                        Chocolate cake biscuit donut cotton candy soufflé cake
                                        macaroon. Halvah chocolate cotton candy sweet roll jelly-o candy danish dragée.
                                        Apple pie cotton candy tiramisu biscuit cake muffin
                                        tootsie roll bear claw cake. Cupcake cake fruitcake. Powder chocolate bar
                                        soufflé gummi bears topping donut. Danish jelly-o cotton
                                        candy sugar plum chocolate bar bonbon pastry. Cotton candy muffin cake sweet
                                        roll marshmallow chocolate cake liquorice fruitcake.
                                    </p>
                                    <div class="row g-3 mb-4">
                                        <div class="mb-3 col-12 col-sm-auto me-1">
                                            <label class="fw-bold form-label">Color <span class="required">*</span></label>
                                            <div class="pt-1">
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" class="form-check-input" name="inlineRadio"
                                                           id="inlineRadio1"/>
                                                    <label class="form-check-label" for="inlineRadio1">Red <span class="required">*</span></label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input type="radio" class="form-check-input" name="inlineRadio"
                                                           id="inlineRadio2"/>
                                                    <label class="form-check-label" for="inlineRadio2">Blue <span class="required">*</span></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-3 col-auto me-1">
                                            <label class="fw-bold form-label">Size <span class="required">*</span></label>
                                        ...
                                        <div class="mb-3 col-auto">
                                            <label class="fw-bold form-label">Quantity <span class="required">*</span></label>
                                            <select class="sw-10 select-single-no-search">
                                ...
                                <div>
                                    <a class="btn btn-icon btn-icon-end btn-outline-primary me-sm-1 mb-1 mb-sm-0 w-100 w-sm-auto"
                                       href="/Storefront/Checkout">
                                        <span>Purchase</span>
                                        <i data-cs-icon="check-square"></i>
                                    </a>
            ...
            <div class="col-12 col-xl-8 col-xxl-9 mb-5">
                ...
                <div class="card mb-5">
                    <div class="card-body">
                        ...
                        <p class="mb-4">
                            Liquorice caramels apple pie chupa chups bonbon. Jelly-o candy apple pie sugar plum icing
                            chocolate cake lollipop jujubes bear claw. Pastry
                            sweet roll carrot cake cake macaroon gingerbread cookie.Candy pie sweet roll biscuit
                            marzipan. Chocolate bar candy canes macaroon liquorice
                            danish biscuit biscuit.
                        </p>
                        <h6>Muffin</h6>
                        <p class="mb-4">
                            Tiramisu toffee brownie sweet roll sesame snaps halvah. Icing carrot cake cupcake gummi
                            bears danish. Sesame snaps muffin macaroon tiramisu
                            ice cream. Liquorice caramels apple pie chupa chups bonbon. Jelly-o candy apple pie sugar
                            plum icing chocolate cake lollipop jujubes bear
                        ...
                        <p class="mb-4">
                            ...
                            gingerbread cookie cookie lemon drops tootsie roll lollipop. Tiramisu toffee brownie sweet
                            roll sesame snaps halvah. Icing carrot cake
                            cupcake gummi bears danish.
                        </p>
                        <h6>Powder Cake</h6>
                        <p class="mb-4">
                            Sesame snaps brownie gummi bears tootsie roll caramels dragée. Powder cake gummies jelly
                            beans toffee carrot cake bonbon powder muffin.
                            Jujubes candy jelly-o topping lemon drops. Cupcake gingerbread cookie cookie lemon drops
                            tootsie roll lollipop. Liquorice caramels apple pie
                            ...
                            macaroon gingerbread cookie.Carrot cake jelly-o lemon drops toffee tootsie roll. Brownie
                            topping toffee apple pie apple pie. Wafer pudding
                            chocolate bar pastry bear claw tart carrot cake lemon drops icing. Gingerbread toffee
                            topping. Tootsie roll cotton candy muffin cheesecake
                            ...
                            cake macaroon. Halvah chocolate cotton candy sweet roll jelly-o candy danish dragée. Apple
                            pie cotton candy tiramisu biscuit cake muffin
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-5">
                            <div class="col-12 col-sm-auto mb-3 mb-sm-0">
                                <div
                                    class="w-100 sw-sm-19 sw-md-23 border sh-16 rounded-md d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="d-flex align-items-center border-bottom border-separator-light pb-3 mt-3">
                            <div class="row g-0 w-100">
                                ...
                                <div class="col pe-3">
                                    ...
                                    <div class="text-medium text-alternate lh-1-25">Cupcake cake fruitcake. Powder
                                        chocolate bar soufflé gummi bears topping donut.
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex align-items-center border-bottom border-separator-light pb-3 mt-3">
                            <div class="row g-0 w-100">
                                <div class="col-auto">
                                    <div class="sw-5 me-3">
                                        <img src="{{ asset('/img/profile/profile-3.jpg') }}" class="img-fluid rounded-xl"
                                             alt="thumb"/>
                                    </div>
                                </div>
                                <div class="col pe-3">
                        ...
                        <div class="d-flex align-items-center pb-3 mt-3">
                            <div class="row g-0 w-100">
                                <div class="col-auto">
                                    <div class="sw-5 me-3">
                                        <img src="{{ asset('/img/profile/profile-4.jpg') }}" class="img-fluid rounded-xl"
                                             alt="thumb"/>
                                    </div>
                                </div>
                                <div class="col pe-3">
                                    ...
                                    <div class="text-medium text-alternate lh-1-25">
                                        Chupa chups topping pastry halvah. Jelly cake jelly sesame snaps jelly beans
                                        jelly beans. Biscuit powder brownie powder sesame snaps
                                        jelly-o dragée cake. Pie tiramisu cake jelly lemon drops. Macaroon sugar plum
                                        apple pie carrot cake jelly beans chocolate.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body mb-n2">
                        <div class="row g-0 mb-2">
                            ...
                            <div class="col">
                                <p class="text-primary ps-3 mb-2 fw-bold">
                                    Carrot cake jelly-o lemon drops toffee tootsie roll. Brownie topping toffee apple
                                    pie apple pie?
                                </p>
                                <p class="text-body ps-3">
                                    Danish croissant bonbon danish muffin icing sugar plum marzipan oat cake. Biscuit
                                    powder brownie powder sesame snaps jelly-o dragée
                                    cake. Pie tiramisu cake jelly lemon drops. Macaroon sugar plum apple pie carrot cake
                                    jelly beans chocolate. Brownie bear claw tart.
                        ...
                        <div class="row g-0 mb-2">
                            ...
                            <div class="col">
                                ...
                                <p class="text-body ps-3">Chupa chups topping pastry halvah. Jelly cake jelly sesame
                                    snaps jelly beans jelly beans.</p>
                            </div>
                        </div>
                        <div class="row g-0 mb-2">
                            <div class="col-auto">
                            ...
                            <div class="col">
                                ...
                                <p class="text-body ps-3">
                                    Gingerbread caramels topping gummi bears halvah dessert cake. Wafer muffin
                                    gingerbread danish donut donut tootsie roll. Soufflé
                        ...
                        <div class="row g-0 mb-2">
                            ...
                            <div class="col">
                                <p class="text-primary ps-3 mb-2 fw-bold">Dragée dessert gummies liquorice halvah
                                    chocolate?</p>
                                <p class="text-body ps-3">
                                    Ice cream ice cream candy gingerbread tiramisu jelly-o jelly. Brownie bear claw
                                    tart. Powder danish ice cream brownie chupa chups
                        ...
                        <div class="row g-0 mb-2">
                            ...
                            <div class="col">
                                ...
                                <p class="text-body ps-3">
                                    Cake danish gingerbread wafer. Sugar plum sweet jelly-o chocolate cake lemon drops.
                                    Jujubes brownie marshmallow apple pie donut ice
                                    cream jelly-o jelly-o gummi bears. Tootsie roll chocolate bar dragée bonbon
                                    cheesecake icing. Danish wafer donut cookie caramels gummies
                                    topping. Toffee cupcake gummi bears gummies dragée danish chocolate bar. Roll
                                    cupcake sugar plum.
                                </p>
                            </div>
                        </div>
                                            ...
                                            <div class="card-body d-flex align-items-center h-100 py-3">
                                                <div class="mb-0 h6">
                                                    <a href="/Storefront/Detail" class="body-link stretched-link">
                                                        <div class="clamp-line sh-3 lh-1-5" data-line="1">Plain
                                                            Baguette
                                                        </div>
                                                    </a>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div
                                                            class="text-muted d-inline-block text-small align-text-top">
                                                            (5)
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row g-0 sh-16 sh-sm-17">
                                        ...
                                        <div class="col p-0">
                                            <div class="card-body d-flex align-items-center h-100 py-3">
                                                <div class="mb-0 h6">
                                                    <a href="/Storefront/Detail" class="body-link stretched-link">
                                                        <div class="clamp-line sh-3 lh-1-5" data-line="1">Bucellato di
                                                            Lucca
                                                        </div>
                                                    </a>
                                                    <div class="card-text mb-2">
                                    ...
                                    <div class="row g-0 sh-16 sh-sm-17">
                                        ...
                                        <div class="col p-0">
                                            <div class="card-body d-flex align-items-center h-100 py-3">
                                                <div class="mb-0 h6">
                                                    <a href="/Storefront/Detail" class="body-link stretched-link">
                                                        <div class="clamp-line sh-3 lh-1-5" data-line="1">Steirer Brot
                                                        </div>
                                                    </a>
                                                    <div class="card-text mb-2">
                                                        <div class="text-muted text-overline text-small sh-2"></div>
