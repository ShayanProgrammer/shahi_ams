            ...
            <div class="row">
                ...
                <div class="col-3 d-flex align-items-end justify-content-end">
                    ...
                    <div class="btn-group ms-1 check-all-container">
                        ...
                        <a href="{{ route('create_user') }}" class="btn btn-outline-primary btn-icon btn-icon-start ms-0 ms-sm-1 w-100 w-md-auto">
                            <span>Add User</span>
                            ...
                            columns: [
                                ...
                                {data: 'role_name', title: 'Role'},
                                {
                                    ...
                                    render: function (data, type, full, meta) {
                                        var change_password = '<a href="{{ url('users/change_password') }}/'+full['id']+'" class="btn btn-sm btn-icon btn-icon-start btn-outline-primary ms-1">Change Password</a>';
                                        if(full['id'] != 1) {

                                            var edit_btn = '<a href="{{ url('users/edit') }}/'+full['id']+'" class="btn btn-sm btn-icon btn-icon-start btn-outline-primary ms-1">Edit</a>';
                                            ...
                                            return change_password + " " + edit_btn + " " + delete_btn;
                                        } else {
