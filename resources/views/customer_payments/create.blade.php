        ...
        <div class="row">
            <div class="col-12 mb-5">
                <section class="scroll-section" id="address">
                    ...
                    @endif
                    <form class="tooltip-end-top" id="addressForm" novalidate="novalidate" method="post" action="{{ route('store_customer_payment') }}">
                        @csrf
                        <div class="card mb-5">
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <div class="w-100" data-select2-id="1">
                                                ...
                                                <select class="select-single-no-search" name="customer_id" data-placeholder="Select Customer">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="amount" autocomplete="off" class="form-control" value="{{ old('amount') }}" placeholder="Enter Payment Amount">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            <div class="w-100" data-select2-id="1">
                                                ...
                                                <select class="select-single-no-search" name="payment_type_id" id="payment_type_id" data-placeholder="Select Payment Type">
                                    ...
                                    <div class="col-md-4" id="cheque_no_div">
                                        <div class="mb-3">
                                            <label class="form-label">Cheque No <span class="required">*</span></label>
                                            <input type="text" name="cheque_no" autocomplete="off" class="form-control" placeholder="Enter Cheque Number" value="{{ old('cheque_no') }}">
                                        </div>
                                    </div>
